        ...
        <div class="relative bg-white dark:bg-gray-800 rounded-lg max-w-lg w-full p-6 shadow-xl">
          ...
          <form @submit.prevent="handleSubmit" class="space-y-4">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
              ...
              <div>
                <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">
                  {{ t('accounting.startDate') }} <span class="text-red-500">*</span>
                </label>
                <input
              ...
              <div>
                <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">
                  {{ t('accounting.endDate') }} <span class="text-red-500">*</span>
                </label>
                <input
            ...
            <div class="flex justify-end space-x-3 mt-6 pt-4 border-t border-gray-200 dark:border-gray-700">
              ...
              <button
                type="submit"
                :disabled="isSubmitting || !formData.year || !formData.start_date || !formData.end_date"
